...
abstract class G5Plus_Widget extends WP_Widget {
	...
	public function enqueue_resources(){
		// base
		wp_enqueue_style(G5PLUS_FRAMEWORK_PREFIX . 'widget', plugins_url(PLUGIN_G5PLUS_FRAMEWORK_NAME . '/widgets/assets/css/widget.css'), array(), false, 'all');
		wp_enqueue_script(G5PLUS_FRAMEWORK_PREFIX.'widget',plugins_url(PLUGIN_G5PLUS_FRAMEWORK_NAME . '/widgets/assets/js/widget.js'),array(),false,true);
				...
				case "icon":
					...
					<div>
						...
						<div>
							...
							<input style="float: right"  title="<?php echo esc_html__('Click to browse icon','g5plus-orson') ?>" class="browse-icon button-secondary" type="button" value="<?php echo esc_html__('Browse...','g5plus-orson') ?>" />
				...
				case "image":
					...
					<div style="margin: 13px 0">
						...
						<div class="widget-image-field">
							...
							<button style="float: right" title="<?php echo esc_html__('Click to browse image','g5plus-orson') ?>" class="browse-images button-secondary" type="button"><?php echo esc_html__('Browse...','g5plus-orson') ?></button>
						</div>
