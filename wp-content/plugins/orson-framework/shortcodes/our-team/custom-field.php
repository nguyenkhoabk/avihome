<div class="my_meta_control">
    <?php while($mb->have_fields_and_multi('ourteam',array('length' => 2))): ?>
        ...
        <label><?php esc_html_e('Name', 'g5plus-orson'); ?></label>
        ...
        <label><?php esc_html_e('Link', 'g5plus-orson'); ?></label>
        <input class="form-control" type="text" name="<?php esc_attr($mb->the_name()); ?>" value="<?php esc_attr($mb->the_value()); ?>"/>

        <?php $mb->the_field('socialIcon'); ?>
        <label><?php esc_html_e('Icon', 'g5plus-orson'); ?></label>
    ...
    <p>
        <a href="#" class="docopy-ourteam button"><?php esc_html_e('Add Social', 'g5plus-orson'); ?></a>
...
<style>
	...
	.my_meta_control .dodelete:hover,
	.my_meta_control .browse-icon:hover,
	.my_meta_control .docopy-ourteam:hover,
	.my_meta_control .dodelete-ourteam:hover {
		background-color: #333;
		color: #fff;
		border: 1px solid #333;
	}

	.my_meta_control .browse-icon {
		padding-right: 10px;
		width: auto !important;
		margin-top: 20px;;
	}
	.my_meta_control .input-icon {
		width: 99% !important;
	}
    ...
    { color:#999; display:inline-block; margin-top: 20px; text-align: right;}

	.my_meta_control span i {
		font-size: 24px;
		line-height: 28px;
		color: #333;
	}
