...
$location = 'header_customize_' . $customize_location . '_phone';
if (!$customize[$location]['label'] && !$customize[$location]['value']) {
	return;
}
$wrapper_class = array('header-customize-item' ,'item-info' , 'item-phone');
if (!$customize[$location]['label'] || !$customize[$location]['value']) {
	$wrapper_class[] = 'full-height';
}
?>
<div class="<?php echo join(' ', $wrapper_class); ?>">
	<a href="tel:<?php echo esc_attr($customize[$location]['value']); ?>"><i class="fa fa-phone"></i></a>
