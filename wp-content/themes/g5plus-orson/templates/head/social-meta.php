 ...
 */
$post = get_post();
$enable_social_meta = G5Plus_Global::get_option('social_meta_enable');
...
$twitter_author    = G5Plus_Global::get_option('twitter_author_username');
$googleplus_author = G5Plus_Global::get_option('googleplus_author');
...
$logo = G5Plus_Global::get_option('logo');
