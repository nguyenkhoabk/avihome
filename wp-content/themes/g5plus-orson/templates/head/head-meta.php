...
$custom_favicon = G5Plus_Global::get_option('custom_favicon');
if (isset($custom_favicon['url']) && !empty($custom_favicon['url'])) {
    $favicon = $custom_favicon['url'];
}
$custom_ios_icon144 = G5Plus_Global::get_option('custom_ios_icon144');
$custom_ios_icon114 = G5Plus_Global::get_option('custom_ios_icon114');
$custom_ios_icon72 = G5Plus_Global::get_option('custom_ios_icon72');
$custom_ios_icon57 = G5Plus_Global::get_option('custom_ios_icon57');
$custom_ios_title = G5Plus_Global::get_option('custom_ios_title');
?>
<meta charset="<?php bloginfo( 'charset' ); ?>"/>
<meta name="viewport" content="<?php echo esc_attr($viewport_content);?>">

<?php if (!empty($custom_ios_title)) : ?>
    <meta name="apple-mobile-web-app-title" content="<?php echo esc_attr(G5Plus_Global::get_option('custom_ios_title')); ?>">
<?php endif; ?>
