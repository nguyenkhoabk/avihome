				...
				<div id="redux-add-widget" class="widgets-holder-wrap">
				 <div class="">
				  ...
				  <div class="sidebar-name">
				   <h3><?php echo esc_html__('Create Widget Area', 'g5plus-orson'); ?> <span class="spinner"></span></h3>
				  </div>
				  <div class="sidebar-description">
					<form id="addWidgetAreaForm" action="" method="post">
				      <div class="widget-content">
				        <input id="redux-add-widget-input" name="redux-add-widget-input" type="text" class="regular-text" title="<?php echo esc_html__('Name', 'g5plus-orson'); ?>" placeholder="<?php echo esc_html__('Name', 'g5plus-orson'); ?>" />
				      </div>
				      <div class="widget-control-actions">
				        <div class="aligncenter">
				          <input class="addWidgetArea-button button-primary" type="submit" value="<?php echo esc_html__('Create Widget Area', 'g5plus-orson'); ?>" />
				        </div>
				        <br class="clear">
				      </div>
				    </form>
