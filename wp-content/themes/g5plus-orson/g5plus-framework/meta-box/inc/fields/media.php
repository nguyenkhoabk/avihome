...
class RWMB_Media_Field extends RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_localize_script( 'rwmb-media', 'i18nRwmbMedia', array(
			'add'                => apply_filters( 'rwmb_media_add_string', esc_html_x( '+ Add Media', 'media', 'g5plus-orson' ) ),
			'single'             => apply_filters( 'rwmb_media_single_files_string', esc_html_x( ' file', 'media', 'g5plus-orson' ) ),
			'multiple'           => apply_filters( 'rwmb_media_multiple_files_string', esc_html_x( ' files', 'media', 'g5plus-orson' ) ),
			'remove'             => apply_filters( 'rwmb_media_remove_string', esc_html_x( 'Remove', 'media', 'g5plus-orson' ) ),
			'edit'               => apply_filters( 'rwmb_media_edit_string', esc_html_x( 'Edit', 'media', 'g5plus-orson' ) ),
			'view'               => apply_filters( 'rwmb_media_view_string', esc_html_x( 'View', 'media', 'g5plus-orson' ) ),
			'noTitle'            => esc_html_x( 'No Title', 'media', 'g5plus-orson' ),
			'loadingUrl'         => RWMB_URL . 'img/loader.gif',
			'extensions'         => self::get_mime_extensions(),
			'select'             => esc_html_x( 'Select Files', 'media', 'g5plus-orson' ),
			'uploadInstructions' => esc_html_x( 'Drop files here to upload', 'media', 'g5plus-orson' )
		) );
	}
