...
class RWMB_File_Field extends RWMB_Field
{
	...
	static function admin_enqueue_scripts()
	{
		...
		wp_localize_script( 'rwmb-file', 'rwmbFile', array(
			'maxFileUploadsSingle' => esc_html__( 'You may only upload maximum %d file', 'g5plus-orson' ),
			'maxFileUploadsPlural' => esc_html__( 'You may only upload maximum %d files', 'g5plus-orson' ),
		) );
	}
	...
	static function wp_ajax_delete_file()
	{
		...
		if ( $success )
			...
			wp_send_json_error( esc_html__( 'Error: Cannot delete file', 'g5plus-orson' ) );
	}
	...
	{
		$i18n_title = apply_filters( 'rwmb_file_upload_string', esc_html_x( 'Upload Files', 'file upload', 'g5plus-orson' ), $field );
		$i18n_more  = apply_filters( 'rwmb_file_add_string', esc_html_x( '+ Add new file', 'file upload', 'g5plus-orson' ), $field );
	...
	{
		$i18n_delete = apply_filters( 'rwmb_file_delete_string', esc_html_x( 'Delete', 'file upload', 'g5plus-orson' ) );
		$i18n_edit   = apply_filters( 'rwmb_file_edit_string', esc_html_x( 'Edit', 'file upload', 'g5plus-orson' ) );
		$item        = '
		<li id="item_%s">
