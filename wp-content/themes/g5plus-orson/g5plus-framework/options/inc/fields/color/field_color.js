            ...
            function() {
                ...
                el.find( '.redux-color-init' ).wpColorPicker({
                    change: function( u ) {
	                    ...
	                    el.find('.colors > span').removeClass('active');
                    },
                    clear: function() {
                ...
                el.find( '.redux-color' ).on(
                    'keyup', function() {
                        ...
                        if ( value === "transparent" ) {
	                        ...
	                        el.find('.colors > span').removeClass('active');
	                        el.find('.colors > span').each(function() {
		                        var valColor = $(this).attr('data-color');
		                        if (value.toLowerCase() == valColor.toLowerCase()) {
	            ...
	            el.find('.colors > span').on('click', function() {
		            el.find('.colors > span').removeClass('active');
		            $(this).addClass('active');
		            var valColor = $(this).attr('data-color');
		            el.find( '.redux-saved-color' ).val( valColor );
		            el.find( '#' + $( this ).data( 'id' ) ).val( valColor );
		            el.find( '#' + $( this ).data( 'id' ) ).parent().parent().find( '.wp-color-result' ).css(
			            'background-color', valColor
		            );
	            });
            }
        );
