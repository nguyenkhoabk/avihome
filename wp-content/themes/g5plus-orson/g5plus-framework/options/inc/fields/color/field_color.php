...
if ( ! class_exists( 'ReduxFramework_color' ) ) {
    ...
    class ReduxFramework_color {
        ...
        public function render() {
	        ...
	        if (isset( $this->field['colors'] ) && is_array($this->field['colors']) ) {
		        echo '<div class="colors">';
				foreach ($this->field['colors'] as $color) {
					if ( $this->value == $color ) {
						echo '<span class="active" data-id="' . $this->field['id'] . '-color" data-color="' . esc_attr($color) . '" style="background-color:' . esc_attr($color) . '"></span>';
					}
					else {
						echo '<span data-id="' . $this->field['id'] . '-color" data-color="' . esc_attr($color) . '" style="background-color:' . esc_attr($color) . '"></span>';
					}
