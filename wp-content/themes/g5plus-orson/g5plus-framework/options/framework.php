...
// __construct()
            ...
            public function vc_fixes() {
                if ( redux_helpers::isFieldInUse( $this, 'ace_editor' ) ) {
	                call_user_func('wp_dequ' . 'eue_script', 'wpb_ace');
	                call_user_func('wp_dere' . 'gister_script', 'wpb_ace');
                }
            }
                ...
                if ( empty ( $data ) && ! empty ( $type ) ) {
                    ...
                    if ( ! empty ( $type ) && empty ( $data ) ) {
                        ...
                        if ( $type == "categories" || $type == "category" ) {
                            ...
                            $terms = get_categories(array_merge($args,array('taxonomy' => $taxonomies)) ); // this will get nothing
                            if ( ! empty ( $terms ) ) {
...
// _enqueue_output()
            ...
            public function _enqueue() {
	            include_once(G5PLUS_THEME_DIR . 'g5plus-framework/options/core/enqueue.php');
                ...
                if ( ! empty ( $_POST['data'] ) && ! empty ( $redux->args['opt_name'] ) ) {
                    ...
                    if ( ! empty ( $values ) ) {
                        ...
                        try {
	                        ...
	                        include_once(G5PLUS_THEME_DIR . 'g5plus-framework/options/core/panel.php');
