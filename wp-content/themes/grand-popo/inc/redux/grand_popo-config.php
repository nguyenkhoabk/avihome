...
Redux::setSection($opt_name, array(
    ...
    'id' => 'opt-premium',
    'desc' =>'<div class="gp_upgrade_wrap"><h4>Upgrade to Grand-Popo Premium for more great features. Over 50 more theme options, premium shop features, custom post types and much much more!</h4><a class="button button-primary " href="https://themeforest.net/item/grand-popo-a-minimal-woocommerce-blog-theme/17449958?ref=orionorigin&utm_source=Free%20Trial&utm_medium=cpc&utm_term='.urlencode("upgrade-page").'&utm_campaign=Grand-Popo">'
    . 'Upgrade</a><a href="https://themeforest.net/item/grand-popo-a-minimal-woocommerce-blog-theme/17449958?ref=orionorigin&utm_source=Free%20Trial&utm_medium=cpc&utm_term='.urlencode("upgrade-page").'&utm_campaign=Grand-Popo">
